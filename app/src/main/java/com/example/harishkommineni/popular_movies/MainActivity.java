    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (parcelable != null) {
                ...
                mGridView.setAdapter(new ArrayAdapter(this, movies));
            }
        }
    }
        ...
        if (isNetworkAvailable()) {
            ...
            OnTaskCompleted taskCompleted = new OnTaskCompleted() {
                ...
                public void onFetchMoviesTaskCompleted(Movie[] movies) {
                    mGridView.setAdapter(new ArrayAdapter(getApplicationContext(), movies));
                }
            };

            // Execute task
            FetchMovieTasks movieTask = new FetchMovieTasks(taskCompleted, apiKey);
